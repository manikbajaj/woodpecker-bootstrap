google.maps.__gjsload__("infowindow", function(_) {
  var VP = function() {
    ...
    XP = function(a, b, c) {
      if (c) {
        ...
        var e = _.X("div", d),
          f = _.X("div", a);
        e.style.position = d.style.position = f.style.position = a.style.position =
          "absolute";
    ...
    cQ = function(a, b, c, d) {
      ...
      _.R.na(f, "contextmenu", this, this.Fl);
    ...
    hQ = function(a) {
      ...
      if (!d) return null;
      b
        ? ((a = b.X - b.U - (gQ.width + 23 + 30)),
          (b = b.Y - b.W - (gQ.height + 18 + -d.height)),
          200 <= a && (a -= 100),
          200 <= b && (b -= 100))
        : (b = a = 654);
      a = Math.min(a, 654);
    ...
    dQ = function(a) {
      a.C && (a.C.Bj.cancel(), a.C.Mj.cancel(), (a.C = null));
      var b = hQ(a);
      if (b) {
    ...
    kQ = function(a, b, c) {
      ...
      this.m = [];
      var g = new _.nw(["scale"], "visible", function(a) {
        return null == a || 0.3 <= a;
      });
      ...
      if (this.j) {
        ...
        f = function() {
          var c = a.get("position"),
            e = b.getBounds();
          c && e && e.contains(c) ? _.Nm(m, "-v", d) : _.Om(m, "-v", d);
        };
    ...
    lQ = function(a, b, c) {
      return b instanceof _.ce ? new kQ(a, b, c) : new kQ(a, b);
    },
    mQ = function(a) {
      a = a.__gm;
      return (a.IW_AUTO_CLOSER = a.IW_AUTO_CLOSER || new VP());
    };
  YP.prototype.Da = _.pa("sa");
  YP.prototype.setSize = function(a) {
    var b = a.width,
      c = a.height;
    _.ne(this.j, a);
  ...
  var aQ = Object.freeze(new _.N(12, 10)),
    gQ = Object.freeze(new _.O(0, 24));
  kQ.prototype.close = function() {
    if (this.C) {
      this.C = !1;
      this.j && (_.Om(this.j, "-p", this), _.Om(this.j, "-v", this));
  ...
  _.He("infowindow", {
    tj: function(a) {
      ...
      (0, _.R.ja)(a, "map_changed", function d() {
        var e = a.get("map");
        b && (b.Qg.j.remove(a), b.Rl.close(), (b = null));
        if (e) {
          var f = e.__gm;
          f.get("panes")
            ? ((b = {
