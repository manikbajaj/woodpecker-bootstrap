...
function re(e, t) {
  var o = Math.round,
    ...
    d = r.width % 2 == i.width % 2,
    a = 1 == r.width % 2 && 1 == i.width % 2,
    l = function(e) {
      return e;
    },
    f = t ? (p || s || d ? o : Math.floor) : l,
    m = t ? o : l;
  return {
    left: f(a && !s && t ? i.left - 1 : i.left),
    top: m(i.top),
    bottom: m(i.bottom),
    right: f(i.right)
  };
...
function se(e, t) {
  ...
  return (
    (e.attributes = D({}, y, e.attributes)),
    (e.styles = D({}, f, e.styles)),
  ...
  Te = (function() {
    function e(t, o) {
      ...
      L(this, e),
        ...
        Object.keys(D({}, e.Defaults.modifiers, i.modifiers)).forEach(function(
          t
        ) {
