/**
 * @module app/shortcodes/ztshAnimateProgress.js
 * @author Uneebox
 * @since Version 1.0.0
 * @returns object ztshAnimateProgress
...
{
	// Declaring the ztshAnimateProgress Object
	var ztshAnimateProgress =
		{
			// publiCall property to use methods in object
			publicCall: function (obj)
			{
				ztshAnimateProgress.animateProgress(obj);
			},
