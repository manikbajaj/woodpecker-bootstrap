				...
				jQuery(window).scroll(function ()
				{
					...
					function stickyNav()
					{
						...
						if (scrollTop >= 1)
						{
							...
							jQuery(".wdpk-transparent-logo").addClass("wdpk-hide");
							jQuery(".wdpk-navbar-logo").addClass("wdpk-hide");
							jQuery(".wdpk-sticky-logo").removeClass("wdpk-hide");
						}
						else if (scrollTop == 0)
						{
							jQuery(".wdpk-sticky-navbar").removeClass("wdpk-sticky");
							jQuery(".wdpk-cart-dropdown").css("top", cartTop);
							jQuery(".wdpk-sticky-logo").addClass("wdpk-hide");

							if (jQuery(".wdpk-transparent-navbar").length !== 0){
								jQuery(".wdpk-transparent-logo").removeClass("wdpk-hide");
							} else {
								jQuery(".wdpk-navbar-logo").removeClass("wdpk-hide");
							}
						}
					};
