/**
 * @module app/shortcodes/wdpkCounter.js
 * @author Uneebox
 * @since Version 1.0.0
 * @returns object wdpkCounter
	...
	var wdpkCounter =
		{
			...
			loadCounter: function (obj)
			{
				...
				let options = {
					...
					decimal: obj.decimal,
					prefix: '<span class="wdpk-counter-prefix">' + obj.prefix + '</span>',
					suffix: '<span class="wdpk-counter-suffix">' + obj.suffix + '</span>'
				};
